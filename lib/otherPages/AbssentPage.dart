        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: AppBar(
              leading: IconButton(
                icon:
                    const Icon(Icons.arrow_back_ios, color: app_colors.orange),
                onPressed: () {
              ...
              title: Image.asset("assets/images/2....2.png",
                  height: 100, width: 90),
              toolbarHeight: 150,
              actions: [
                        ...
                        child: Column(
                          children: [
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    cubit
                                        .handleIntent(SearchStudent(query: ''));
                                  },
                                ),
                            ...
                            Row(
                              ...
                              children: [
                                Text('Total: ${cubit.numberofstudents}',
                                    style: const TextStyle(
                                        color: app_colors.orange)),
                                Text('Absent: ${cubit.studentsList.length}',
                                    style: const TextStyle(
                                        color: app_colors.orange)),
                                Text('Present: ${cubit.attendStudents.length}',
                                    style: const TextStyle(
                                        color: app_colors.orange)),
                              ],
                            ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    child: const Text("Start Taking Absence",
